...
Important: treat these docs as the source of truth for current behavior. The top-level `README.md` is older and does not fully reflect the MCP, structural tools, eval harness, reranker behavior, or the recent retrieval/ranking work.

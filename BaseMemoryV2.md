...
2. [Comet.md](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/103203160/0c49ff23-5a9d-4bd7-ad00-dc355e474ef6/Comet.md?AWSAccessKeyId=ASIA2F3EMEYE6TMDOCFP&Signature=JMX46oRnaGj4cxhzbdhgcrP2f3A%3D&x-amz-security-token=IQoJb3JpZ2luX2VjEPv%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaCXVzLWVhc3QtMSJGMEQCIFRmJSuF7W%2F31YnnJiDEHvX1nBiUakbKv7tCFNu4S5dgAiAjF7aycJc7WlEsWAhTQqDwdtQpGaV6umuxCSeFwSH3pSr8BAjD%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F8BEAEaDDY5OTc1MzMwOTcwNSIMmehk%2FlqztlJalMVkKtAEuLhPutQoKTf5Nhk5mItW4Xu5cptyxmQdTWczT62deLxMkITVvXp6CP5sI7uegAzIsBVNVyLi2FI38338qQhddtAp7S4uPZav%2Fk3jU8O33jBgY%2FBlCmIlG582NTKuXUNbu%2Bjy3twg7jTWzUBMeo4Sp8498K6HxrDvNAfFBX3xtCvz5WkLHh%2F%2BZId%2BQ99JNqTBBdwuJKVt5edY2%2Bc4eZSRp6uXSfpvckZxuMG%2Bu8XIHisV7wzb%2Fi1%2FpgRyDVRUcNbH8B92GoJ6%2FRB8ArgvbPUZDyhCJv2AwSO3Ubh2Jlh6AwCRm20P5dmI4UOYw8KrFlx3i2vifCEr%2BjEAtxYifeszguXUPWCCYstx7n9pzsi1PY7NXAjk%2FJd9P4oiNzpqgSS36ytxp7Dop%2B69rq%2FJ7y4iMoTPDZsj8CE5wleqcE66eN1b2dJ%2FOM2cgQOLWLKIcE9cgAlTQXgISip98BxbtKAB%2BqUssLDkhwQ9a9OG11NH97NQJyRRF46pFB5J4bGt7ht31jCWfnGlD8zGcODIiklvqScngZn%2B8mW%2BGTx0zVPdCAqezdchB8EvlSPIduUPNJ4H9KRqPyFntU0l5p4w62mYuh4n9xnLoSz0lf75cVsgxLKH%2BItwNUs%2Fr%2BbN3HPA%2BHTmAjRyY4E6NV7VjY6%2BuxiCF4cxDWa9634rYyE9tjsonGBjh24N8FDRthL9S%2FOdCe4jBsZXjBbyPiRuOj%2FrmO%2BvCnrLKCwM6iMvtRM%2BZsxp1SO564CqMRQ969%2FTVSyzSyRbONsfzP3z4Wr4Yd5sOL9xnTDLrszOBjqZAd678j%2FeMzp1E7VxbonGRCzJpfJMih4RF6Jo7XAN1yau0UvxgtPXceGaGRoLcMMYf1eRgq%2BvDkofHcWOai4FnTToDsV9iRTel7GdomeanCI8vW8k8ry%2B1fuUrYTTf5ciKpKpQbXUcYvgzAT5KuQHXyCiLsYZx%2BCe71auKnnq6bqizW0DXO4wFacJFLeczHnDWFHn7ITxuwRLPQ%3D%3D&Expires=1775445278) - You are a senior software architect and AI systems researcher specializing in
...
13. [Build Real-Time Codebase Indexing for AI Code Generation](https://cocoindex.io/blogs/index-code-base-for-rag) - In this blog, we will show you how to index a codebase for RAG with CocoIndex. CocoIndex provides bu...

14. [Build a Real-Time Codebase Index in 5 Minutes with CocoIndex ...](https://dev.to/badmonster0/build-a-real-time-codebase-index-in-5-minutes-with-cocoindex-rust-tree-sitter-eo3) - ✓ Proper code parsing (not just text chunking) ✓ Vector embeddings for semantic search ✓ Real-time s...

15. [Building code-chunk: AST Aware Code Chunking - Supermemory](https://supermemory.ai/blog/building-code-chunk-ast-aware-code-chunking/) - How code-chunk Works · Step 1: Parse with tree-sitter · Step 2: Extract Entities · Step 3: Build the...

16. [How to Build Semantic Chunking - OneUptime](https://oneuptime.com/blog/post/2026-01-30-semantic-chunking/view) - A practical guide to implementing semantic chunking for RAG applications, with working code examples...

17. [Splitting with purpose: Semantic chunking for advanced RAG systems](https://ai.plainenglish.io/splitting-with-purpose-semantic-chunking-for-advanced-rag-systems-dbbdb73fe421) - This article explores a sophisticated approach to RAG that leverages semantic chunking, hybrid searc...

18. [Hybrid Search Explained | Weaviate](https://weaviate.io/blog/hybrid-search-explained) - Hybrid search merges dense and sparse vectors together to deliver the best of both search methods. G...

19. [Retrieve & Re-Rank — Sentence Transformers documentation](https://sbert.net/examples/sparse_encoder/applications/retrieve_rerank/README.html) - Re-ranking both sparse and dense results with cross-encoder/ms-marco-MiniLM-L6-v2. Hybrid Search usi...

20. [Semantic Search for Code - Qdrant](https://qdrant.tech/documentation/tutorials-search-engineering/code-search/) - Qdrant is an Open-Source Vector Search Engine written in Rust. It provides fast and scalable vector ...

21. [Hybrid Search and the Universal Query API - Qdrant](https://qdrant.tech/course/essentials/day-3/hybrid-search/) - Learn how to combine dense and sparse vector search methods to build powerful hybrid search pipeline...

22. [Cross-Encoder Rediscovers a Semantic Variant of BM25 - Shaped.ai](https://www.shaped.ai/blog/cross-encoder-rediscovers-a-semantic-variant-of-bm25) - This article explores how cross-encoders, long praised for their performance in neural ranking, may ...

23. [CodeRAG: Retrieval-Augmented Code Synthesis - Emergent Mind](https://www.emergentmind.com/topics/coderag) - CodeRAG is a family of retrieval-augmented generation methodologies designed for automated code comp...

24. [How Cursor uses Merkle trees for code indexing and privacy](https://www.linkedin.com/posts/pratikdaga-sf_indexing-a-large-codebase-quickly-without-activity-7343708355628015619-G6Mm) - At its core, a Merkle tree is just a hash tree. You take your files, hash them, then hash those hash...
...
48. [Local Code Search Index MCP Server Based on Zoekt - AIBase](https://mcp.aibase.com/server/1586804740191429026) - Code Index MCP Server is a tool specifically designed for code search. It can build a code index on ...

49. [GitHub - JaredStewart/coderlm: Tree-sitter-powered code indexing ...](https://github.com/JaredStewart/coderlm) - CodeRLM applies the Recursive Language Model (RLM) pattern to codebases. A Rust server indexes a pro...

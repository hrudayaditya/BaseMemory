...
- [MCP Clients and Tool Guide](./docs/mcp-clients.md)
...
- [Cross-repo Benchmarking](./docs/benchmarking-cross-repo.md)
- [Adding Language Support](./docs/adding-language-support.md)
- [Incremental Index Orchestrator Handoff](./docs/incremental-index-orchestrator-handoff.md)

## Which Doc To Read

- You use Claude Code, Cursor, Windsurf, or another MCP client:
  - read [MCP Clients and Tool Guide](./docs/mcp-clients.md)
- You are changing code in this repo:
  - read [Developer Guide](./docs/developer-guide.md)
- You are tuning retrieval quality or running benchmark gates:
  - read [Evaluation Harness](./docs/evaluation.md)
